...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our ONLINE INSTANT FOOD MIX SALES!</h1>
                    <p>We have the best quality of instant food mix items. We value our customer satisfaction more.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/dosa.jfif" alt="DOSA">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>DOSA</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/dal vada.jfif" alt="DAL VADA">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>DAL VADA</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/dahivada.jfif" alt="DAHI VADA">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>DAHI VADA</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/idly.jfif" alt="IDLY">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>IDLY</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/millet briyani.jfif" alt="MILLET BRIYANI">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>MILLET BRIYANI</h3>
                                    <p>Price: Rs. 190.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/medu vada.jfif" alt="MEDU VADA">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>MEDU VADA</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/omelete.jfif" alt="OMLETE">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>OMELETE</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/pizza.jfif" alt="PIZZA">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>PIZZA</h3>
				...
				<div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/ragi dosa.jfif" alt="RAGI DOSA">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>RAGI DOSA</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/rava dosa.jfif" alt="RAVA DOSA">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>RAVA DOSA</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/rice pongal.jfif" alt="RICE PONGAL">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>RICE PONGAL</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/upma.jfif" alt="UPMA">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>UPMA</h3>
				...
				<div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sambar.jfif" alt="SAMBAR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>SAMBAR</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/manchurian.jfif" alt="MANCHURIAN">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>MANCHURIAN</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/suji.jfif" alt="SUJI">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>SUJI</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/gulab jamun.jfif" alt="GULAB JAMUN">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>GULAB JAMUN</h3>
